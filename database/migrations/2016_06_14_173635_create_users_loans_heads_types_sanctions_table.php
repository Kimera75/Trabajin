...
class CreateUsersLoansHeadsTypesSanctionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('users_loans_heads_types_sanctions', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->dateTime('release_date')->required();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::drop('users_loans_heads_types_sanctions');
    }
}
